...
// drawing big cat for the main title screen
  tft.fillRect(60,10,30,10,ORANGE);
  tft.fillRect(160,10,30,10,ORANGE);
  tft.fillRect(60,20,10,10,ORANGE);
  tft.fillRect(70,20,10,10,BROWN);
  tft.fillRect(80,20,10,10,ORANGE);
  tft.fillRect(160,20,10,10,ORANGE);
  tft.fillRect(170,20,10,10,BROWN);
  tft.fillRect(170,30,20,10,BROWN);
  tft.fillRect(180,20,20,10,ORANGE);
  tft.fillRect(50,30,20,10,ORANGE);
  tft.fillRect(70,30,20,10,BROWN);
  tft.fillRect(90,30,10,10,ORANGE);
  tft.fillRect(150,30,20,10,ORANGE);
  tft.fillRect(190,30,10,10,ORANGE);
  tft.fillRect(50,40,10,10,ORANGE);
  tft.fillRect(60,40,30,10,BROWN);
  tft.fillRect(90,40,10,10,ORANGE);
  tft.fillRect(150,40,10,10,ORANGE);
  tft.fillRect(160,40,30,10,BROWN);
  tft.fillRect(190,40,20,10,ORANGE);
  tft.fillRect(30,50,30,10,GRAY);
  tft.fillRect(60,50,130,20,ORANGE);
  tft.fillRect(200,50,10,10,ORANGE);
  tft.fillRect(210,50,20,10,GRAY);
  tft.fillRect(200,60,20,10,GRAY);
  tft.fillRect(30,50,30,10,GRAY);
  tft.fillRect(50,60,10,10,GRAY);
  tft.fillRect(20,70,30,10,GRAY);
  tft.fillRect(50,70,30,10,ORANGE);
  tft.fillRect(80,70,20,10,WHITE);
