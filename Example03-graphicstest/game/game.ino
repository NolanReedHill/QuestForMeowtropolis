...
unsigned long gameOver(int s) {
  switch(gameOverSequence) {
    ...
    tft.fillRect(73,229,1,1,GRAY);
    tft.fillRect(74,230,1,1,GRAY);
    tft.fillRect(59,216,10,2,ORANGE);
    tft.fillRect(59,216,1,1,BLACK);
    tft.fillRect(60,217,1,1,BLACK);
    tft.fillRect(59,218,1,1,BLACK);
    tft.fillRect(62,216,1,1,BLACK);
    tft.fillRect(62,218,1,1,BLACK);
    tft.fillRect(65,216,1,1,BLACK);
    tft.fillRect(67,217,1,1,BLACK);
    tft.fillRect(55,218,1,1,BLACK);
    tft.fillRect(68,216,1,1,BLACK);
    tft.fillRect(68,218,1,1,BLACK);
